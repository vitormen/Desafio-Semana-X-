...
const SignUp = () => {
    ...
    const handleData = (e: React.ChangeEvent<HTMLInputElement>) => {
        ...
        if((newData.length == 2 || newData.length == 5) && newData.length > date.length){
            newData += "/"
        }
        ...
        <Navbar  thereIsLoggedOut={true} thereIsProfile={false} thereIsUserEdit={false}/>
            <C.Container>
                ...
                <C.Card>
                    ...
                    <C.Input widthbutton={"21rem"} margintop={"1rem"} type="text" id="name" name="name" placeholder="Nome"></C.Input>
                    <C.AreaButton>
                        <C.Input widthbutton={"7.8125rem"} margintop={"1rem"} type="text" id="birthday" name="birthday" placeholder="Nascimento" onChange={handleData} value={date}></C.Input>
